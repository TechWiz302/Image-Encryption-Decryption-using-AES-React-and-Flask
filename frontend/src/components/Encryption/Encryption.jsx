...
function Encryption() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await fetch("https://api-aes.onrender.com/encrypted_download", {
                method: 'POST',
                body: formData,
                mode: 'cors',
            });
                ...
                <div className="heroSection-area section_padding">
                    <div className="heroSection_content w-50">
                        <form onSubmit={handleFormSubmit}>
                            <div className="title">
                                <h1>Upload Your Image Here <span>For Encryption</span></h1>
                            </div>
